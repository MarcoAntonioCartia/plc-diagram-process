...
def test_pdf_text_extraction():
    ...
    # Find a test PDF
    pdf_folder = Path("D:/MarMe/github/0.3/plc-data/raw/pdfs")
...
def test_ocr_initialization():
    ...
    try:
        ...
        print("Attempting CPU-only PaddleOCR initialization...")
        ocr = PaddleOCR(lang='en', use_gpu=False, use_angle_cls=False)
